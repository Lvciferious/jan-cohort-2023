...
Your friend is working on a function called isSorted()
which checks if an array of numbers is in order, sorted lowest to highest.
...
console.log(isSorted([1,3,2,2, 5])); //false
console.log(isSorted([1, 2, 4, 6, 8])); //true
